...
@ComponentScan(value = "com.webcrudsecurityboot.webcrudsecurityboot")
public class HiberConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManager.setPackagesToScan(new String[]{"com.webcrudsecurityboot.webcrudsecurityboot.model"});
